...
Ahri:MenuElement({leftIcon = "https://vignette.wikia.nocookie.net/leagueoflegends/images/2/2c/Ahri_OriginalCircle.png", name = "VIP Ahri", drop = {"1.0"}})
Ahri:MenuElement({leftIcon = "https://vignette.wikia.nocookie.net/leagueoflegends/images/9/9b/Champ_Mastery_S3b.png", name = " ", drop = {"Core"}})
...
Ahri:MenuElement({leftIcon = "https://vignette.wikia.nocookie.net/leagueoflegends/images/0/0a/Classic_Ward.png", name = " ", drop = {"Utility"}})
...
Ahri.C:MenuElement({id = "Q", name = "Q - " ..Q.Name, value = true, leftIcon = Q.Icon})
Ahri.C:MenuElement({id = "W", name = "W - " ..W.Name, value = true, leftIcon = W.Icon})
Ahri.C:MenuElement({id = "E", name = "E - " ..E.Name, value = true, leftIcon = E.Icon})
Ahri.C:MenuElement({id = "R", name = "R - " ..R.Name, value = true, leftIcon = R.Icon})
...
Ahri.H:MenuElement({id = "Q", name = "Q - " ..Q.Name, value = true, leftIcon = Q.Icon})
Ahri.H:MenuElement({id = "W", name = "W - " ..W.Name, value = true, leftIcon = W.Icon})
Ahri.H:MenuElement({id = "E", name = "E - " ..E.Name, value = true, leftIcon = E.Icon})

Ahri.LC:MenuElement({id = "Q", name = "Q - " ..Q.Name, value = true, leftIcon = Q.Icon})
Ahri.LC:MenuElement({id = "Qx", name = "Minions Hit by Q", value = 4, min = 1, max = 7})
Ahri.LC:MenuElement({id = "W", name = "W - " ..W.Name, value = true, leftIcon = W.Icon})
Ahri.LC:MenuElement({id = "Wx", name = "Minions Hit by W", value = 3, min = 1, max = 3})
Ahri.LC:MenuElement({id = "E", name = "E - " ..E.Name, value = false, leftIcon = E.Icon})
Ahri.LC:MenuElement({name = " ", drop = {"E for jungle only"}})
Ahri.LC:MenuElement({name = " ", drop = {"Minions manager for lane only"}})

Ahri.KS:MenuElement({id = "Q", name = "Q - " ..Q.Name, value = true, leftIcon = Q.Icon})
Ahri.KS:MenuElement({id = "E", name = "E - " ..E.Name, value = true, leftIcon = E.Icon})
Ahri.KS:MenuElement({id = "RC", name = "Dont KS if recalling", value = true})

Ahri.F:MenuElement({id = "Q", name = "Q - " ..Q.Name, value = true, leftIcon = Q.Icon})
Ahri.F:MenuElement({id = "E", name = "E - " ..E.Name, value = true, leftIcon = E.Icon})
Ahri.F:MenuElement({id = "R", name = "R - " ..R.Name, value = true, leftIcon = R.Icon})
Ahri.F:MenuElement({id = "Ra", name = "Only R if already active", value = true})

Ahri.AU:MenuElement({id = "Q", name = "Auto Q on CC", value = true, leftIcon = Q.Icon})
Ahri.AU:MenuElement({id = "E", name = "Safe auto E", value = true, leftIcon = E.Icon})
