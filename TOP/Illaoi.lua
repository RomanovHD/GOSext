...
local Q = { Range = 850, Delay = myHero:GetSpellData(_Q).delay, Speed = myHero:GetSpellData(_Q).speed, Width = myHero:GetSpellData(_Q).width}
local W = { Range = 450}
local E = { Range = myHero:GetSpellData(_E).range, Delay = myHero:GetSpellData(_E).delay, Speed = myHero:GetSpellData(_W).speed, Width = myHero:GetSpellData(_E).width}
...
--// Menu
local Illaoi = MenuElement({type = MENU, id = "Illaoi", name = "HD Illaoi"})

Illaoi:MenuElement({id = "Script", name = "Illaoi", drop = {"HD v1"}})
Illaoi:MenuElement({name = " ", drop = {"Champion Core"}})
Illaoi:MenuElement({type = MENU, id = "C", name = "Combo"})
Illaoi:MenuElement({type = MENU, id = "H", name = "Harass"})
Illaoi:MenuElement({type = MENU, id = "LC", name = "LaneClear"})
Illaoi:MenuElement({type = MENU, id = "JC", name = "JungleClear"})
Illaoi:MenuElement({name = " ", drop = {"Champion Utility"}})
Illaoi:MenuElement({type = MENU, id = "K", name = "Keys"})
Illaoi:MenuElement({type = MENU, id = "MM", name = "Mana"})
Illaoi:MenuElement({type = MENU, id = "D", name = "Drawings"})
Illaoi:MenuElement({name = " ", drop = {"Extra Utility"}})
Illaoi:MenuElement({type = MENU, id = "A", name = "Activator"})
Illaoi:MenuElement({type = MENU, id = "Lv", name = "Auto Leveler"})

Illaoi.C:MenuElement({id = "Q", name = "Q: Tentacle Smash", value = true})
Illaoi.C:MenuElement({id = "W", name = "W: Harsh Lesson", value = true})
Illaoi.C:MenuElement({id = "E", name = "E: Test of Spirit", value = true})
Illaoi.C:MenuElement({id = "R", name = "R: Leap of Faith [?]", value = true, tooltip = "1v1/Teamfight Logic"})
Illaoi.C:MenuElement({id = "Rx", name = "[X] Enemies to R", value = 3, min = 1, max = 5})

Illaoi.H:MenuElement({id = "Q", name = "Q: Tentacle Smash", value = true})

Illaoi.LC:MenuElement({id = "Q", name = "Q: Tentacle Smash", value = true})
Illaoi.LC:MenuElement({id = "QMin", name = "Minions to Q", value = 5, min = 1, max = 7})

Illaoi.JC:MenuElement({id = "Q", name = "Q: Tentacle Smash", value = true})
Illaoi.JC:MenuElement({id = "W", name = "W: Harsh Lesson", value = true})

Illaoi.K:MenuElement({id = "Clear", name = "Spell Clear", key = string.byte("A"), toggle = true})
Illaoi.K:MenuElement({id = "Harass", name = "Spell Harass", key = string.byte("S"), toggle = true})

Illaoi.MM:MenuElement({id = "C", name = "Mana % to Combo", value = 0, min = 0, max = 100})
Illaoi.MM:MenuElement({id = "H", name = "Mana % to Harass", value = 60, min = 0, max = 100})
Illaoi.MM:MenuElement({id = "LC", name = "Mana % to Lane", value = 55, min = 0, max = 100})
Illaoi.MM:MenuElement({id = "JC", name = "Mana % to Jungle", value = 30, min = 0, max = 100})

Illaoi.A:MenuElement({type = MENU, id = "P", name = "Potions"})
Illaoi.A.P:MenuElement({id = "Pot", name = "All Potions", value = true})
Illaoi.A.P:MenuElement({id = "HP", name = "Health % to Potion", value = 60, min = 0, max = 100})
Illaoi.A:MenuElement({type = MENU, id = "I", name = "Items"})
Illaoi.A.I:MenuElement({id = "RO", name = "Randuin's Omen", value = true})
Illaoi.A.I:MenuElement({id = "Proto", name = "Hextec Items (all)", value = true})
Illaoi.A:MenuElement({type = MENU, id = "S", name = "Summoner Spells"})
DelayAction(function()
	...
	or myHero:GetSpellData(SUMMONER_2).name == "SummonerSmite" or myHero:GetSpellData(SUMMONER_2).name == "S5_SummonerSmitePlayerGanker" or myHero:GetSpellData(SUMMONER_1).name == "S5_SummonerSmiteDuel" then
		Illaoi.A.S:MenuElement({id = "Smite", name = "Smite in Combo [?]", value = true, tooltip = "If Combo will kill"})
		Illaoi.A.S:MenuElement({id = "SmiteS", name = "Smite Stacks to Combo", value = 1, min = 1, max = 2})
	end
end, 2)
DelayAction(function()
	if myHero:GetSpellData(SUMMONER_1).name == "SummonerHeal"
	or myHero:GetSpellData(SUMMONER_2).name == "SummonerHeal" then
		Illaoi.A.S:MenuElement({id = "Heal", name = "Auto Heal", value = true})
		Illaoi.A.S:MenuElement({id = "HealHP", name = "Health % to Heal", value = 25, min = 0, max = 100})
	end
end, 2)
DelayAction(function()
	if myHero:GetSpellData(SUMMONER_1).name == "SummonerBarrier"
	or myHero:GetSpellData(SUMMONER_2).name == "SummonerBarrier" then
		Illaoi.A.S:MenuElement({id = "Barrier", name = "Auto Barrier", value = true})
		Illaoi.A.S:MenuElement({id = "BarrierHP", name = "Health % to Barrier", value = 25, min = 0, max = 100})
	end
end, 2)
DelayAction(function()
	if myHero:GetSpellData(SUMMONER_1).name == "SummonerDot"
	or myHero:GetSpellData(SUMMONER_2).name == "SummonerDot" then
		Illaoi.A.S:MenuElement({id = "Ignite", name = "Ignite in Combo", value = true})
	end
end, 2)
DelayAction(function()
	if myHero:GetSpellData(SUMMONER_1).name == "SummonerExhaust"
	or myHero:GetSpellData(SUMMONER_2).name == "SummonerExhaust" then
		Illaoi.A.S:MenuElement({id = "Exh", name = "Exhaust in Combo [?]", value = true, tooltip = "If Combo will kill"})
	end
end, 2)
DelayAction(function()
	if myHero:GetSpellData(SUMMONER_1).name == "SummonerBoost"
	or myHero:GetSpellData(SUMMONER_2).name == "SummonerBoost" then
		Illaoi.A.S:MenuElement({id = "Cleanse", name = "Auto Cleanse", value = true})
		Illaoi.A.S:MenuElement({id = "Blind", name = "Blind", value = false})
		Illaoi.A.S:MenuElement({id = "Charm", name = "Charm", value = true})
		Illaoi.A.S:MenuElement({id = "Flee", name = "Flee", value = true})
		Illaoi.A.S:MenuElement({id = "Slow", name = "Slow", value = false})
		Illaoi.A.S:MenuElement({id = "Root", name = "Root/Snare", value = true})
		Illaoi.A.S:MenuElement({id = "Poly", name = "Polymorph", value = true})
		Illaoi.A.S:MenuElement({id = "Silence", name = "Silence", value = true})
		Illaoi.A.S:MenuElement({id = "Stun", name = "Stun", value = true})
		Illaoi.A.S:MenuElement({id = "Taunt", name = "Taunt", value = true})
	end
end, 2)
Illaoi.A.S:MenuElement({type = SPACE, id = "Note", name = "Note: Ghost/TP/Flash is not supported"})

Illaoi.D:MenuElement({id = "Q", name = "Q: Tentacle Smash", value = true})
Illaoi.D:MenuElement({id = "W", name = "W: Harsh Lesson", value = false})
Illaoi.D:MenuElement({id = "E", name = "E: Test of Spirit", value = true})
Illaoi.D:MenuElement({id = "R", name = "R: Leap of Faith", value = false})
Illaoi.D:MenuElement({id = "T", name = "Spell Toggle", value = true})

Illaoi.Lv:MenuElement({id = "Enabled", name = "Enable", value = true})
Illaoi.Lv:MenuElement({id = "Block", name = "Block on Level 1", value = true})
Illaoi.Lv:MenuElement({id = "Order", name = "Skill Priority", value = 5, drop = {"[Q] - [W] - [E] > Max [Q]","[Q] - [E] - [W] > Max [Q]","[W] - [Q] - [E] > Max [W]","[W] - [E] - [Q] > Max [W]","[E] - [Q] - [W] > Max [E]","[E] - [W] - [Q] > Max [E]"}})
...
function AutoLevel()
	if Illaoi.Lv.Enabled:Value() == false then return end
	local Sequence = {
	...
	local Check = Sequence[Illaoi.Lv.Order:Value()][level - SkillPoints + 1]
	if SkillPoints > 0 then
		if Illaoi.Lv.Block:Value() and level == 1 then return end
...
function Summoners()
	...
	if GetMode() == "Combo" then
		if myHero:GetSpellData(SUMMONER_1).name == "SummonerSmite" or myHero:GetSpellData(SUMMONER_1).name == "S5_SummonerSmitePlayerGanker" or myHero:GetSpellData(SUMMONER_1).name == "S5_SummonerSmiteDuel"
		or myHero:GetSpellData(SUMMONER_2).name == "SummonerSmite" or myHero:GetSpellData(SUMMONER_2).name == "S5_SummonerSmitePlayerGanker" or myHero:GetSpellData(SUMMONER_1).name == "S5_SummonerSmiteDuel" then
			if Illaoi.A.S.Smite:Value() then
				...
				and myHero:GetSpellData(SUMMONER_1).ammo >= Illaoi.A.S.SmiteS:Value() and myHero.pos:DistanceTo(target.pos) < 500 then
					Control.CastSpell(HK_SUMMONER_1, target)
				elseif myHero:GetSpellData(SUMMONER_2).name == "S5_SummonerSmiteDuel" and Ready(SUMMONER_2) and RedDamage > target.health
				and myHero:GetSpellData(SUMMONER_2).ammo >= Illaoi.A.S.SmiteS:Value() and myHero.pos:DistanceTo(target.pos) < 500 then
		...
		if myHero:GetSpellData(SUMMONER_1).name == "SummonerDot"
		or myHero:GetSpellData(SUMMONER_2).name == "SummonerDot" then
			if Illaoi.A.S.Ignite:Value() then
	...
	if myHero:GetSpellData(SUMMONER_1).name == "SummonerHeal"
	or myHero:GetSpellData(SUMMONER_2).name == "SummonerHeal" then
		if Illaoi.A.S.Heal:Value() then
			if myHero:GetSpellData(SUMMONER_1).name == "SummonerHeal" and Ready(SUMMONER_1) and PercentHP(myHero) < Illaoi.A.S.HealHP:Value() then
				Control.CastSpell(HK_SUMMONER_1)
			elseif myHero:GetSpellData(SUMMONER_2).name == "SummonerHeal" and Ready(SUMMONER_1) and PercentHP(myHero) < Illaoi.A.S.HealHP:Value() then
	...
	if myHero:GetSpellData(SUMMONER_1).name == "SummonerBarrier"
	or myHero:GetSpellData(SUMMONER_2).name == "SummonerBarrier" then
		if Illaoi.A.S.Barrier:Value() then
			if myHero:GetSpellData(SUMMONER_1).name == "SummonerBarrier" and Ready(SUMMONER_1) and PercentHP(myHero) < Illaoi.A.S.BarrierHP:Value() then
				Control.CastSpell(HK_SUMMONER_1)
			elseif myHero:GetSpellData(SUMMONER_2).name == "SummonerBarrier" and Ready(SUMMONER_1) and PercentHP(myHero) < Illaoi.A.S.BarrierHP:Value() then
				Control.CastSpell(HK_SUMMONER_2)
			end
		end
	end
